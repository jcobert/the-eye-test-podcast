  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-y-16 md:gap-y-20 lg:gap-y-28">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 md:gap-x-4 gap-y-10 justify-items-stretch">
          ...
          <div className="md:col-start-2 lg:col-start-3 lg:col-span-3">
            ...
            <iframe
              className="w-full max-w-md sm:max-w-xl mx-auto md:mx-0 border border-slate-400 shadow rounded-sm overflow-hidden"
